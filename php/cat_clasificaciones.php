...
<html lang="es">
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            ...
                            <a href="cat_clasificaciones.php.php" class="active"><i class="fa fa-dashboard fa-fw"></i> Clasificaciones</a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Catálogo de clasificaciónes de los ritos</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row" >
