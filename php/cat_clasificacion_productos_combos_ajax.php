...
?>
    <option value="0">--------- SELECCIONE UNA OPCIÓN ---------</option>
                            <?php
                            $sql2 = "SELECT * FROM clasificaciones_productos where activo=1 and cve_rito=$cveRito and cve_clasificacion=$cveClasificacion and cve_grado=$cveGrado  ORDER BY descripcion";
...
?>
     ...
     <option value="0">--------- SELECCIONE UNA OPCIÓN ---------</option>
                            <?php
                               $sql2 = "SELECT * FROM clasificaciones_productos where activo=1 and cve_rito=$cveRito and cve_clasificacion=$cveClasificacion  and cve_grado=$cveGrado"
